...
export function LoginClient({ initialLanguage }: { initialLanguage: StaffLocale }) {
      ...
      <div className="grid w-full gap-8 lg:grid-cols-[1fr_0.84fr] lg:items-center">
        <div className="px-2 sm:px-4 lg:px-8">
          <div className="space-y-4">
            ...
            <p className="text-lg uppercase tracking-[0.28em] text-stone sm:text-xl">{copy.authBrandSubtitle}</p>
          </div>
        </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="rounded-[24px] border border-black/5 bg-sand/40 p-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <p className="text-xs uppercase tracking-[0.28em] text-stone">{copy.demoCredentials}</p>
